...
const blogs = [
  {
    ...
    image_url: "https://i.pinimg.com/originals/f9/a2/25/f9a22515a2fac3cf9e6d5877f5939c41.jpg",
  },
  {
    id: uuid(),
    postedOn: moment().format("MMMM Do YYYY"),
...
app.get("/blog", (req, res) => {
  res.render("home", { blogs, titleTag: "Home" });
});

// GET - /blog/new
app.get("/blog/new", (req, res) => {
  res.render("addnewPost", { titleTag: "Add New Post" });
});
...
app.post("/blog", (req, res) => {
  ...
  // adding this new post to the blogs array
  blogs.push(newPost);
...
app.get("/blog/:id", (req, res) => {
  ...
  res.render("post", { post, titleTag: `${post.title}` });
});
...
app.patch("/blog/:id", (req, res) => {
  const { id } = req.params;
  const updatedPost = blogs.find(p => p.id === id);
